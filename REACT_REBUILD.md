...
- voice capture
- permanent category manager
- preservation pre-check builder
- complete wardrobe interface
- final book-source detail pages
- final migration from the legacy local-storage schema
